...
const PartName = () => {
  ...
  const fetchPartName = async () => {
    try {
      setLoading(true);
      const { data, error } = await supabase.from("part_name").select("*");
      if (error) throw error;

      const partNameData = data.map((row) => ({
        id: row.id_part_name,
        nama: row.nama,
      }));
      setAllData(partNameData);
    } catch (error) {
  ...
  const handleEdit = async () => {
    ...
    try {
      ...
      const { error } = await supabase
        ...
        .eq("id_part_name", selectedItem.id);
        ...
        <div className="p-6">
          <div className="mb-4">
            ...
            <input
              ...
              placeholder="Enter part name name..."
        ...
        <div className="p-6">
          ...
          <div className="text-center mb-6">
            <p className="text-gray-700">
              Are you sure you want to delete the part name{" "}
